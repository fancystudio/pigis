...
$smarty->assign('silent',$this->GetPreference('silent',0));
$smarty->assign('checkmemory',$this->GetPreference('checkmemory',1));
$smarty->assign('force_extension',$this->GetPreference('force_extension',0));
