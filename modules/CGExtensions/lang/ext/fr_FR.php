<?php
$lang['msg_templatesaved'] = 'Gabarit sauvegard&eacute;';
$lang['prompt_memory_limit'] = 'Limite de la m&eacute;moire&nbsp;';
$lang['info_memory_limit'] = 'Certaines fonctionnalit&eacute;s de certains modules testent s&#039;il y a assez de m&eacute;moire disponible pour continuer. Toutefois, certains h&eacute;bergeurs ne permettent pas de lire cette information de mani&egrave;re fiable. Vous pouvez entrer une limite de m&eacute;moire pris en charge <em>(en Mo)</em> pour aider cette fonctionnalit&eacute;. En laissant le champ vide, on tentera de s&#039;appuyer sur la lecture de cette information du syst&egrave;me.';
$lang['help'] = 'Aide';
...
$lang['CGFILEUPLOAD_FILESIZE'] = 'La taille du fichier upload&eacute; exc&egrave;de le maximun autoris&eacute;';
