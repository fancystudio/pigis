...
if( !isset( $params['email'] ) )
  ...
  $mailer->reset();
  $mailer->SetSubject($this->GetPreference('usersettings_subject'));		

  $bodyText = $this->ProcessTemplateFromDatabase('usersettings_email_body');
  ...
  echo $this->ProcessTemplateFromDatabase('usersettings_text');
