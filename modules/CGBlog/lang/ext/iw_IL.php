...
$lang['eventdesc-CGBlogArticleAdded'] = 'נשלח כשנוסף מאמר.';
$lang['eventhelp-CGBlogArticleAdded'] = '<p>נשלח כשנוסף מאמר.</p>
<h4>פרמטרים</h4>
<ul>
<li>\"cgblog_id\" - קוד הזיהוי של המאמר</li>
...
';
$lang['eventdesc-CGBlogArticleEdited'] = 'נשלח כשמאמר נערך.';
$lang['eventhelp-CGBlogArticleEdited'] = '<p>נשלח כשמאמר נערך.</p>
<h4>פרמטרים</h4>
<ul>
<li>\"cgblog_id\" - קוד הזיהוי של המאמר</li>
...
$lang['eventdesc-CGBlogArticleDeleted'] = 'נשלח כשמאמר נמחק.';
$lang['eventhelp-CGBlogArticleDeleted'] = '<p>נשלח כשמאמר נמחק.</p>
<h4>פרמטרים</h4>
<ul>
<li>\"cgblog_id\" - קוד הזיהוי של המאמר</li>
</ul>';
$lang['eventdesc-CGBlogCategoryAdded'] = 'נשלח כאשר נוסף מדור.';
$lang['eventhelp-CGBlogCategoryAdded'] = '<p>נשלח כאשר נוסף מדור.</p>
<h4>פרמטרים</h4>
<ul>
...
';
$lang['eventdesc-CGBlogCategoryEdited'] = 'נשלח כאשר מדור נערך.';
$lang['eventhelp-CGBlogCategoryEdited'] = '<p>נשלח כאשר מדור נערך.</p>
<h4>פרמטרים</h4>
<ul>
<li>\"category_id\" - קוד הזיהוי של המדור</li>
<li>\"name\" - שם המדור</li>
...
';
$lang['eventdesc-CGBlogCategoryDeleted'] = 'נשלח כאשר מדור נמחק.';
$lang['eventhelp-CGBlogCategoryDeleted'] = '<p>נשלח כאשר מדור נמחק.</p>
<h4>פרמטרים</h4>
<ul>
...
$lang['helpsortby'] = 'שדה המיון.  האפשרויות הן: "cgblog_date" (תאריך), "summary" (תקציר), "cgblog_data" (מידע), "cgblog_category" (מדור), "cgblog_title" (כותרת).  ברירת המחדל היא "cgblog_date" (תאריך).';
