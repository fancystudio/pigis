...
$lang['review'] = 'Review';
$lang['info_urltemplate'] = 'This template controls how the ajax URL building system will automatically build your URL.  This is a simplified smarty template.  The available variables are:
<ul>
...
$lang['toggle_filter'] = 'View Filter Form';
...
$lang['helpcategory'] = 'Used in the summary, and archive views to display only items for the specified categories. Multiple categories can be used if separated with a comma. Leaving empty, will show all categories.  This parameter also works for the frontend submit action, however only a single category name is supported.';
